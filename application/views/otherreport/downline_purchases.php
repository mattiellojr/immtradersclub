...
<head>
    ...
    <!-- Title Page-->
    <title>iMM-Traders Club | Other Report - Downline Purchases</title>
    <!-- Fontfaces CSS-->
                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">Downline Purchases</li>
                                        </ul>
                                    </div>
                     ...
                     <div class="section__content section__content--p30">
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <!-- DATA TABLE -->
                                    <h3 class="title-5 m-b-35" id="lvl"> Downline Purchases</h3> 
                                    <div class="table-responsive table-responsive2">
                                        <table class="table table-responsive-data2 table-data2" id="portfolio">
                                            ...
                                            <tfoot>
                                                <td></td>
                                                    <td></td>
                                                    <td><b class="text-success">Total Purchased : </b> </td>
                                                    <td>0.00</td>
                                                    <td></td>
                                                    <td></td>
                                                </tr>
        ...
        $(function() {
            ...
            $( "#btn_submit" ).click(function() {
                        ...
                        $('#portfolio').dataTable( {
                                "bProcessing": true,
                                "bDestroy": true,
                                "sAjaxSource": "search-downline-purchase",
                   ...
                   $('#lvl').html('Downline Purchases for ' +  $('[name=user_id]').val() );
             });
