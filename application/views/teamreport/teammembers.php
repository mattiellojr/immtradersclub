...
<head>
    ...
    <!-- Title Page-->
    <title>iMM-Traders Club | Team Report - Team Members</title>
    <!-- Fontfaces CSS-->
                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">Team Members</li>
                     ...
                     <div class="section__content section__content--p30">
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <!-- DATA TABLE -->
                                    <h3 class="title-5 m-b-35"> Team Members </h3> 
                                    <div class="table-responsive table-responsive2">
                                        <table class="table table-responsive-data2 table-data2" id="portfolio">
                                            ...
                                            <?php   $no = 0 ; foreach($referral_members as $data) { $no +=1;?>   
                                                <tr class="tr-shadow">
                                                    <td><?=$no?></td>
                                                    <td><a href="#"><?=$data['user_id']?></a></td>
                                                    ...
                                                    <td><?=date('F d, Y',strtotime($data['date_registered']))?></td>
                                                </tr>
                                                <?php }  ?>
