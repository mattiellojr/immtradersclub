...
<head>
    ...
    <!-- Title Page-->
    <title>iMM-Traders Club | Team Report - Member Tree</title>
    <!-- Fontfaces CSS-->
                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">Member Tree</li>
                ...
                <div class="main-content">
                     <div class="section__content section__content--p30">
                        <div class="container-fluid">
                             ...
                             <div class="row">
                                <div class="col-md-12">
                                    <h3 class="title-5 m-b-35">Your Upline</h3>
                                    <div class="col-md-4">
                                            <?php  foreach($upline as $key => $value){?>
                                                    <div class="form-group">
                                                        <label>USER ID :</label>
                                                       <input type="text" name="" readonly="" class="form-control" value="<?=$value->user_id?>">
                                                    </div> 
                                                   <div class="form-group">
                                                        <label>USERNAME :</label>
                                                       <input type="text" name="" readonly="" class="form-control" value="<?=$value->username?>">
                                                    </div> 

                                                    <div class="form-group">
                                                        <label>DATE REGISTERED :</label>
                                                       <input type="text" name="" readonly="" class="form-control" value="<?=$value->create_at?>">
                                                    </div> 
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <!-- DATA TABLE -->
                                    <h3 class="title-5 m-b-35">Your Downline Member Tree </h3> 
                                    <div class="col-md-4">
                                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <!-- DATA TABLE -->
                                    <h3 class="title-5 m-b-35" id="lvl"> LEVEL <b>1</b></h3> 
                                    <div class="table-responsive table-responsive2">
                                        <table class="table table-responsive-data2 table-data2" id="portfolio">
                                            <thead>
                                                <tr>
                                                    <th>#</th>
                                                    <th>User ID</th>
        ...
        $(function() {
            ...
            $( "#level" ).change(function() {
                        ...
                        $('#portfolio').dataTable( {
                                "bProcessing": true,
                                "bDestroy": true,
                                "sAjaxSource": "member-tree-downline",
                                "fnServerData": function ( sSource, aoData, fnCallback, oSettings ) {
                                    oSettings.jqXHR = $.ajax( {
                                            "dataType": 'json',
                                            "type": "POST",
                                            "url": sSource,
                                            "data": {level : $('[name=level]').val() ,'imm_token' : $('#token').val()},
                                            "success": fnCallback
                                    } );
                                },
