                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                      <div class="card">
                                        ...
                                        <hr>
                                            <?=form_open('mywallets/mother-wallet/rwallet/fund/transfer',[])?>
                                             <div class="form-group">
                                                <label for="street" class=" form-control-label">Wallet Userid : </label>
                                                <input type="text" readonly="" value="<?=$this->uri->segment(4)?>"  name="sender_id" class="form-control">
                                            ...
                                            <div class="form-group">
                                             ...
                                             <div class="form-group">
                                                <label for="postal-code" class=" form-control-label">Wallet Transaction Password</label>
