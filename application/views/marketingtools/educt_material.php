            ...
            <!-- END BREADCRUMB-->
                <div class="main-content">
                     <div class="section__content section__content--p30">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="alert alert-info">Educational Material</div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                 ...
                                 <div class="embed-responsive embed-responsive-16by9">
                                    <iframe style="overflow:visible;" scrolling="yes" class="embed-responsive-item" src="<?=base_url()?>assets/files/educational_material.pdf" ></iframe>
