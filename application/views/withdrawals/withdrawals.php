...
<head>
    ...
    <!-- Title Page-->
    <title>iMM-Traders Club |  Withdrawals</title>
    <!-- Fontfaces CSS-->
                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">Withdrawals</li>
                                        </ul>
                                    </div>
                     ...
                     <div class="section__content section__content--p30">
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <!-- DATA TABLE -->
                                    <h3 class="title-5 m-b-35" id="lvl"> My Withdrawals</h3> 
                                        ...
                                        <table class="table" id="portfolio" style="font-size: 12px;">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="sum">Amount Withdrawn</th>
                                            ...
                                            <tfoot>
                                                    <td></td>
                                                    <td><small class="text-success">Total Withdrawal : </small> </td>
                                                    <td>0.00</td>
                                                    <td></td>
                                                    <td></td>
                                                    <td></td>
    ...
    <script type="text/javascript">
        $(document).ready( function () {
                ...
                $('#portfolio').dataTable( {
                                "bProcessing": true,
                                "bDestroy": true,
                                "sAjaxSource": "withdrawals/my-withdrawals",
        ...
        $(function() {
            ...
            $( "#btn_submit" ).click(function() {
                        ...
                        $('#portfolio').dataTable( {
                                "bProcessing": true,
                                "bDestroy": true,
                                "sAjaxSource": "withdrawals/search-my-withdrawals",
                                "fnServerData": function ( sSource, aoData, fnCallback, oSettings ) {
                                    oSettings.jqXHR = $.ajax( {
                                            "dataType": 'json',
                                            "type": "POST",
