                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">Portfolio Details</li>
                     ...
                     <div class="section__content section__content--p30">
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <!-- DATA TABLE -->
                                    <h3 class="title-5 m-b-35"> My Portfolio </h3> 
    ...
    <script type="text/javascript">
        ...
        $(function() {
                      ...
                      var table =  $('#portfolio').dataTable( {
                                "bProcessing": true,
                                "bDestroy": true,
                                "sAjaxSource": "my-portfolio/details",
                    ...
                    $('#portfolio').on('click','#close',function() {
                                ...
                                $.confirm({
                                    title: 'Confirm!',
                                    content: 'Are you sure you want to close this portfolio package ?',
                                    buttons: {
                                        confirm: function () {

                                            $.ajax({
                                                     type: "POST",
                                                     url:  "my-portfolio/close", 
