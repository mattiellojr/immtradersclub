...
<head>
    ...
    <!-- Title Page-->
    <title>iMM-Traders Club | My Wallets - Transaction History</title>
    <!-- Fontfaces CSS-->
                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">Purchase History</li>
                                        </ul>
                                    </div>
                     ...
                     <div class="section__content section__content--p30">
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <!-- DATA TABLE -->
                                    <h3 class="title-5 m-b-35" id="lvl"> My Downline Purchase History</h3> 
        ...
        $(function() {
            ...
            $( "#btn_submit" ).click(function() {
                        ...
                        $('#portfolio').dataTable( {
                                "bProcessing": true,
                                "bDestroy": true,
                                "sAjaxSource": "my-purchases/downlines",
                                "fnServerData": function ( sSource, aoData, fnCallback, oSettings ) {
                                    oSettings.jqXHR = $.ajax( {
                                            "dataType": 'json',
                                            "type": "POST",
                                            "url": sSource,
                                            "data": {user_id : $('[name=trans_type]').val(),'date_from':$('[name=date_from]').val(),'date_to':$('[name=date_to]').val(),'imm_token' : $('#token').val()},
                                            "success": fnCallback
                                    } );
                                }
