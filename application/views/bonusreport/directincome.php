...
<head>
    ...
    <!-- Title Page-->
    <title>iMM-Traders Club | Bonus Report - Direct Income</title>
    <!-- Fontfaces CSS-->
                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">Direct Income</li>
                                        </ul>
                                    </div>
                     ...
                     <div class="section__content section__content--p30">
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <!-- DATA TABLE -->
                                    <h3 class="title-5 m-b-35" id="lvl"> My Direct Income History</h3> 
    ...
    <script type="text/javascript">
        $(document).ready( function () {
                  ...
                  $('#portfolio').dataTable( {
                                "bProcessing": true,
                                "bDestroy": true,
                                "sAjaxSource": "direct-income/history",
        ...
        $(function() {
            ...
            $( "#btn_submit" ).click(function() {
                        ...
                        $('#portfolio').dataTable( {
                                "bProcessing": true,
                                "bDestroy": true,
                                "sAjaxSource": "direct-income/history/search",
                                "fnServerData": function ( sSource, aoData, fnCallback, oSettings ) {
                                    oSettings.jqXHR = $.ajax( {
                                            "dataType": 'json',
                                            "type": "POST",
